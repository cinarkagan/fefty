...
shared.CustomSavefefty = 6872274481
if pcall(function() readfile("fefty/CustomModules/6872274481.lua") end) then
	loadstring(readfile("fefty/CustomModules/6872274481.lua"))()
else
	local publicrepo = feftyGithubRequest("CustomModules/6872274481.lua")
	if publicrepo then
