...
shared.CustomSavefefty = 8542275097
if pcall(function() readfile("fefty/CustomModules/8542275097.lua") end) then
	loadstring(readfile("fefty/CustomModules/8542275097.lua"))()
else
	local publicrepo = feftyGithubRequest("CustomModules/8542275097.lua")
	if publicrepo then
