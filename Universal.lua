...
do
	...
	task.spawn(function()
		...
		whitelistloaded = pcall(function()
			local commit = "main"
			for i,v in pairs(game:HttpGet("https://github.com/cinarkagan/whitelists"):split("\n")) do 
			...
			WhitelistFunctions.WhitelistTable = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/cinarkagan/whitelists/"..commit.."/whitelist2.json", true))
